    ...
    <>
      <div className={style.container}>
        ...
        className={style.content_tabs}>
          ...
          <div className={ toggleState === 2 ? style.content + " " + style.active_tabs : style.content }>
            <h2>Content 2</h2>
            <hr />
            <p>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
          ...
          <div className={ toggleState === 3 ? style.content + " " + style.active_tabs : style.content }>
            <h2>Content 3</h2>
            <hr />
            <p>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
          ...
          <div className={ toggleState === 4 ? style.content + " " + style.active_tabs : style.content }>
            <h2>Content 4</h2>
            <hr />
            <p>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
